                                ...
                                <div class="minicart-contain">
                                    ...
                                    <div class="cart-content">
                                        <div class="cart-inner">
                                            <ul class="products" tabindex="1" style="overflow: hidden; outline: none;">
                                                <li>
                                    ...
                                    <div id="ascrail2000" class="nicescroll-rails nicescroll-rails-vr" style="width: 8px; z-index: 50; cursor: default; position: absolute; top: 28px; left: 352px; height: 370px; display: block; opacity: 0;"><div class="nicescroll-cursors" style="position: relative; top: 0px; float: right; width: 6px; height: 214px; background-color: rgb(66, 66, 66); border: 1px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 5px;"></div></div><div id="ascrail2000-hr" class="nicescroll-rails nicescroll-rails-hr" style="height: 8px; z-index: 50; top: 390px; left: 20px; position: absolute; cursor: default; display: none; width: 332px; opacity: 0;"><div class="nicescroll-cursors" style="position: absolute; top: 0px; height: 6px; width: 340px; background-color: rgb(66, 66, 66); border: 1px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 5px; left: 0px;"></div></div></div>
                                </div>
                            </div>
